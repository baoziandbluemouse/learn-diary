...
//Qt项目视图提供了一些便捷类，包括QListWidget, QTableWidget， QTreeWidget等。
//可以更快捷地进行开发
    ...
    , ui(new Ui::MainWindow)
{
    ...
    //创建表格项目，将其插入到表格中
    QTableWidgetItem * tableWidgetItem = new QTableWidgetItem("qt"); //插入到表格中的某一个格子
    _tableWidget->setItem(1,1,tableWidgetItem);
    //创建表头
    QTableWidgetItem * headerV = new QTableWidgetItem("first");
    _tableWidget->setVerticalHeaderItem(0, headerV); //垂直方向的表头
    QTableWidgetItem * headerV2 = new QTableWidgetItem("second");
    _tableWidget->setVerticalHeaderItem(1, headerV2);
    QTableWidgetItem * headerV3 = new QTableWidgetItem("third");
    _tableWidget->setVerticalHeaderItem(2, headerV3);
    QTableWidgetItem * headerH = new QTableWidgetItem("ID");
    _tableWidget->setHorizontalHeaderItem(0, headerH); //水平方向的表头
    QTableWidgetItem * headerH2 = new QTableWidgetItem("QT");
    _tableWidget->setHorizontalHeaderItem(1, headerH2);
    _tableWidget->show();
